...
draw(M1 -- M2, L = scale(0.5) * Label("$d_{12}$", align = Relative(S), position = MidPoint));
draw(M1 -- M3, L = scale(0.5) * Label("$d_{13}$", align = 0.8 * Relative(S),  position = 1.2 * MidPoint));
draw(M2 -- M3, dashed, L = scale(0.5) * Label("$d_{23}$", align = 0.5 * Relative(S), position = MidPoint));
...
draw(arc(M0, point(M01, 0.15), point(M03, 0.15)), L = scale(0.5) * Label("$\alpha_{13}$", align = Relative(S)));
draw(arc(M0, point(M02, 0.4), point(M03, 0.4)), L = scale(0.5) * Label("$\alpha_{23}$", align = Relative(S)), dashed);
